namespace BlogTemplate.Mvc.Kentico.Xperience
{
    ...
    {
        #region Fields
        public const string Prefix = "BlogTemplate.";
        #endregion

        public const string CarouselWidget = Prefix + nameof( CarouselWidget );

        public const string TextWidget = Prefix + nameof( TextWidget );
